...
public class ReviewUploadActivity1 extends toolbarClass {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_review_upload1);

        toolbar = findViewById(R.id.toolbar_review_upload1);
        setSupportActionBar(toolbar);

        abar = getSupportActionBar();
        abar.setDisplayShowTitleEnabled(false);

        drawerLayout = findViewById(R.id.draw_review_upload1);
        Button button = findViewById(R.id.menu_button_review_upload1);
        ...
        navigationView = findViewById(R.id.nav_menu_review_upload1);
        navigationView.setNavigationItemSelectedListener(this);


        Button homeButton = findViewById(R.id.home_button_review_upload1);
        ...
        Button upload_before = findViewById(R.id.review_upload1_before);
